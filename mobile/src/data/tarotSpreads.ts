...
export const TAROT_SPREADS: TarotSpread[] = [
  ...
  },
  {
    ...
    gridRows: 1,
    positions: [
      { no: 1, title: 'Meselenin Kalbi', meaning: 'Kararın etrafındaki en güçlü duygu veya şüphe.', guideQuestion: 'Bu his seni koruyor mu, yoksa gereksizce durduruyor mu?', col: 2, row: 1 },
      { no: 2, title: 'Engeller', meaning: 'Bu adımı atarsan karşılaşabileceğin zorluklar.', guideQuestion: 'Engelin ne kadarı gerçek, ne kadarı zihinde büyüyor?', col: 2, row: 1, crossed: true },
      ...
      { no: 4, title: 'Olası Sonuç', meaning: 'Bugünkü şartlarda ilerlersen beliren sonuç.', guideQuestion: 'Bu sonuç hangi koşullarda desteklenir veya değişir?', col: 3, row: 1 },
    ],
  },
  {
    id: 'confidence',
  ...
  },
  {
    ...
    positions: [
      ...
      { no: 7, title: 'İç Etkiler', meaning: 'Kişinin iç kuvvetleri, hisleri ve tavrı.', guideQuestion: 'İç dünyan bu meseleyi nasıl etkiliyor?', col: 3.25, row: 4 },
      { no: 8, title: 'Dış Etkiler', meaning: 'Çevre, başkalarının beklentisi ve kontrol dışı faktörler.', guideQuestion: 'Dış dünya bu duruma nasıl baskı veya destek veriyor?', col: 3.25, row: 3 },
      { no: 9, title: 'Umutlar / Korkular', meaning: 'İstek ve kaygının birbirine dolandığı yer.', guideQuestion: 'Neyi arzuluyor, neyden kaçınıyorsun?', col: 3.25, row: 2 },
      { no: 10, title: 'Genel Sonuç', meaning: 'Mevcut akışın götürdüğü en olası yön.', guideQuestion: 'Bütün kartlar birlikte hangi sonucu işaret ediyor?', col: 3.25, row: 1 },
    ],
  },
  {
    id: 'conflict',
