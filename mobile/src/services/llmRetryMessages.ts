...
const RETRY_MESSAGES: Record<LlmReadingKind, RetryMessage[]> = {
  coffee: [
    {
      title: 'Dürdane Hanım Mutfağı Toparlıyor',
      message: 'Eyvah, Dürdane Hanım kahveleri taşırdı. 1-2 dakika sonra tekrar dene; hemen ocağı silip fincanı yeniden çeviriyormuş.',
    },
    {
  ...
  palm: [
    {
      title: 'Hikmet Bey Gözlüğünü Arıyor',
      message: 'Hikmet Bey avuç içi çizgilerine bakacaktı ama gözlüğünü masada unuttu. 1-2 dakika sonra tekrar dene; çizgiler kaçmıyor.',
    },
    {
    ...
    },
    {
      ...
      message: 'Avuç içi ışığı biraz parladı, Hikmet Bey gözlerini dinlendirdi. 1-2 dakika sonra tekrar dene; bu kez çizgileri daha net okuyalım.',
    },
  ],
  'personal-astro': [
    {
