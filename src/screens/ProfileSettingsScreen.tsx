...
export function ProfileSettingsScreen({ navigation }: Props) {
  ...
  const handleSaveProfile = useCallback(async () => {
    ...
    const isSelf = editingIsPrimary || profileDraft.relationshipPrimary === 'kendi';
    if (isSelf && (!profileDraft.birthYear || !profileDraft.birthMonth || !profileDraft.birthDay)) {
      return;
    }
            ...
            <SafeAreaView edges={['bottom']} style={styles.modalSafeArea}>
              <ScrollView contentContainerStyle={styles.modalContent} keyboardShouldPersistTaps="handled">
                ...
                <TextInput
                  ...
                  onChangeText={(value) => handleDraftChange('birthCountry', value)}
                />
                <TextInput
                  style={styles.textInput}
                  placeholder="Şehir"
